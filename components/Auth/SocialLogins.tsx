    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2.5 px-4 py-3 border border-forest/15 hover:border-forest/30 bg-white hover:bg-forest/5 rounded-xl font-bold text-sm text-ink/80 transition duration-200"
        >
