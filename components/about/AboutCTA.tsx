      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">
            Bạn cần chọn sản phẩm phù hợp cho bé?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base text-white/80 leading-relaxed">
            Dù là thức ăn hạt, pate hay cát vệ sinh, 3F Store luôn sẵn sàng hỗ trợ ba mẹ thiết lập thực đơn và sản phẩm phù hợp nhất cho bé.
          </p>
