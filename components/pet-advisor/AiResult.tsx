...
export function AiResult({ result, onExploreProducts, onConsultAgent, onShareZalo, onClose, onRestart }: AiResultProps) {
  ...
  return (
    ...
    >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[12px] text-ink-soft mt-1.5 leading-relaxed bg-white/60 p-2 rounded-lg border border-gray-50">
      ...
      {/* Fixed bottom area inside AiResult */}
