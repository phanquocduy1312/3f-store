...
const trustPills = [
  { icon: ShieldCheck, label: "100% chính hãng", tone: "from-blue-50 to-white" },
  { icon: Truck, label: "Freeship từ 299k", tone: "from-sky-50 to-white" },
  { icon: MessageCircleHeart, label: "Tư vấn thú y 24/7", tone: "from-cyan-50 to-white" },
];
...
export function ReasonsSection() {
  ...
  return (
    <section className="reason-mesh-bg relative overflow-hidden bg-[#F0F8FF] py-24 lg:py-32">
      ...
      <div className="pet-float-slow pointer-events-none absolute -left-[10%] top-[18%] h-[800px] w-[800px] rounded-full bg-gradient-to-tr from-blue-100/50 to-cyan-50/40 blur-[100px]" />
      <div className="pet-float pointer-events-none absolute -right-[10%] bottom-[8%] h-[620px] w-[620px] rounded-full bg-gradient-to-bl from-sky-50/40 to-blue-50/40 blur-[120px]" />
      <div
      ...
      <MotionSection className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="mb-20 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <MotionItem {...motionItemProps} className="max-w-3xl">
            ...
            <h2 className="text-5xl font-black leading-[1.05] tracking-tighter text-ink sm:text-[4rem]">
              Vì sao hàng ngàn <span className="text-forest">Boss</span>
              <br />
              tin chọn <span className="relative inline-block">
                3F Store?
                <span className="absolute -bottom-2 left-0 h-4 w-full -rotate-1 rounded-full bg-blue-100/70 blur-sm" />
              </span>
            </h2>
          ...
          <MotionItem {...motionItemProps} className="flex flex-wrap gap-4 pb-4 lg:max-w-[460px] lg:justify-end">
            {trustPills.map((item, index) => (
              <motion.div
                ...
                className={`group relative inline-flex items-center gap-3 overflow-hidden rounded-full border border-border bg-white px-6 py-3.5 text-sm font-extrabold text-forest-dark shadow-[0_8px_20px_rgba(0,0,0,0.03)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_25px_rgba(var(--color-primary),0.08)]`}
              >
        ...
        <div className="grid items-stretch gap-8 lg:grid-cols-[minmax(0,540px)_1fr] xl:grid-cols-[minmax(0,580px)_1fr]">
          <MotionItem
            {...motionItemProps}
            className="group relative flex h-full flex-col justify-between overflow-hidden rounded-[3rem] bg-forest p-8 text-white shadow-[0_30px_60px_rgba(var(--color-primary-darker),0.15)] transition-all duration-500 hover:shadow-[0_40px_80px_rgba(var(--color-primary-darker),0.25)] sm:p-12"
          >
            ...
            <div className="absolute right-[-8%] top-[-10%] h-56 w-56 rounded-full bg-blue-400/10 blur-3xl transition-all duration-700 group-hover:scale-125" />
            ...
            <div className="relative z-20 flex-1">
              <div className="mb-8 inline-flex items-center gap-2 rounded-2xl bg-white/10 px-4 py-2 text-sm font-bold backdrop-blur-md">
                <HeartHandshake size={16} className="text-blue-300" />
              ...
              <h3 className="text-[2.35rem] font-black leading-[1.06] tracking-tighter text-white sm:text-[2.75rem]">
                Chọn lọc kỹ lưỡng,
                <br />
                <span className="text-blue-300">để mỗi bữa ăn đều đáng tin.</span>
              </h3>
              <p className="mt-6 max-w-md text-base font-medium leading-[1.8] text-blue-50/78 sm:text-lg">
            ...
            <div className="relative z-20 mt-10 flex flex-wrap items-center gap-4">
              <button className="inline-flex h-[60px] items-center gap-4 rounded-full bg-white px-8 text-base font-black text-forest transition-all duration-300 hover:scale-[1.02] hover:bg-blue-50 active:scale-95">
                Xem bộ sưu tập
                <span className="grid h-10 w-10 place-items-center rounded-full bg-forest/10">
            ...
            >
              <div className="absolute left-1/2 top-1/2 h-full w-full -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/20 blur-[60px] transition-all duration-700 group-hover:scale-110 group-hover:bg-blue-400/30" />
              <Image
