        ...
        try {
            ...
            foreach ($rows as $row) {
                $data[] = [
                    ...
                    "email"              => $row['email'],
                    "zalo"               => $row['zalo'],
                    "shopeeOrderCode"    => $row['shopee_order_code'],
                    "orderAmount"        => (int)$row['order_amount'],
                    "expectedPoints"     => (int)$row['expected_points'],
                    "approvedPoints"     => (int)$row['approved_points'],
    ...
    public function detail() {
        ...
        try {
            ...
            $requestData = [
                ...
                "orderAmount"        => (int)$request['order_amount'],
                "expectedPoints"     => (int)$request['expected_points'],
                "approvedPoints"     => (int)$request['approved_points'],
