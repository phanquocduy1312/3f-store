...
ADD COLUMN category_slug VARCHAR(150) NULL AFTER category,
ADD COLUMN view_count INT DEFAULT 0 AFTER published_at,
ADD COLUMN seo_score INT DEFAULT 0 AFTER view_count,
ADD COLUMN toc_enabled TINYINT(1) DEFAULT 1 AFTER view_count,
ADD COLUMN toc_title VARCHAR(100) DEFAULT 'Mục lục bài viết' AFTER toc_enabled;
