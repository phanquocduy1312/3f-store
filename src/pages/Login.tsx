        ...
        <div className="w-full max-w-[440px] mx-auto space-y-8">
          ...
          <div className="text-center pt-2">
            <p className="text-sm font-semibold text-ink/60">
              ...
              <Link to="/register" className="font-bold text-forest hover:underline transition">
                Đăng ký ngay
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:flex lg:col-span-5 xl:col-span-6 relative bg-forest-darker overflow-hidden flex-col justify-end p-12 xl:p-16 text-white">
        ...
        <div className="relative z-20 space-y-4">
          ...
          <p className="text-white/80 text-sm leading-relaxed max-w-sm font-medium">
            Hãy đăng nhập tài khoản thành viên để bắt đầu đặt mua các sản phẩm dinh dưỡng cao cấp nhất dành riêng cho người bạn bốn chân của mình.
          </p>
        </div>
      </div>
    </div>
