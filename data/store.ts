...
import { PawPrint, CheckCircle, Truck, Heart } from "lucide-react";
...
export const reasons = [
  { title: "Chất lượng đảm bảo", description: "Sản phẩm chính hãng, kiểm định rõ ràng", icon: CheckCircle },
  { title: "Giao hàng nhanh", description: "Nhiều lựa chọn vận chuyển", icon: Truck },
  { title: "Yêu thú như người thân", description: "Dịch vụ tận tâm", icon: Heart },
  { title: "Cam kết hoàn tiền", description: "Hoàn tiền nếu không đúng mô tả", icon: CheckCircle },
];
