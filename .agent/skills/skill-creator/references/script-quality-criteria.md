...
2. `$HOME/.agent/skills/<skill-name>/.env` (skill-specific)
3. `$HOME/.agent/skills/.env` (shared skills)
4. `$HOME/.agent/.env` (global)
5. `./.agent/skills/${SKILL}/.env` (cwd)
6. `./.agent/skills/.env` (cwd)
7. `./.agent/.env` (cwd)
...
load_dotenv('$HOME/.agent/skills/.env')
load_dotenv('$HOME/.agent/skills/my-skill/.env')
load_dotenv('./.agent/skills/my-skill/.env')
load_dotenv('./.agent/skills/.env')
