...
- Check `.agent-plugin/marketplace.json` exists at specified path
...
|-------|-------|----------|
| `File not found: .agent-plugin/marketplace.json` | Missing manifest | Create `.agent-plugin/marketplace.json` with required fields |
