...
## Visual Aids
- Use `/preview --explain` skill when explaining unfamiliar code patterns or complex logic
- Use `/preview --diagram` skill for architecture diagrams and data flow visualization
- Use `/preview --slides` skill for step-by-step walkthroughs and presentations
- Use `/preview --ascii` skill for terminal-friendly diagrams (no browser needed to understand)
